...
<body style="background-color:#050F7E; background-image:url(images/Black-Wallpaper-Image-Picture-HD-1024x640.jpg)";>



<div style="width:1048px; height:120px; font-size:44px; font-style:italic; color:#FFFFFF; margin:auto;">

   <p style="margin-top:60px; " ><center><b>WELCOME TO BLACKMART</b>	</center>  </p>
...
<table width="523" height="144" border="1" class="text" style="background-color:#323230; margin-top:100px;">
  ...
  <tr>
    ...
    <td colspan="2"><input type="submit" name="submit" id="submit" value="submit" style=" margin-left:150px;background-color:#0033FF; width:70px;"/></td>
