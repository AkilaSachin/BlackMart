...
<!--slider down data-->
            ...
            <table style="height:auto; width:1050px; margin:auto;   border:0px solid #000000; background-color:#FFFFFF; ">
               ...
               <tr><td>   <!--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  LAPTOP %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%-->  
                        ...
                        <div style="height:30px; width:1050px; border:0px solid #000000; color:#269FB2; font-size:18px; background-color:#DAD8D8;border-radius:5px; ">
                        <p style="margin-left:20px; margin-top:5px;"><b> Apple Products</b></p>
                        </div>      
		...
		?>
                   ...
                   <td  style=" width:255px; border:0px solid #0000CC;"align="center" >
                    ...
                    <div style="height:170px; width:230px; border:0px solid #000000;border-radius:15px;margin-top:10px;" align="center">
                    <img src="images/<?php echo $row['image1'];?>" height="140" width="190" >
                    </div> 
