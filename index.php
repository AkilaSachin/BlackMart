...
<!--slider down data-->
            ...
            <!--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%-->        
			 ...
			 $query="select * from product where pro_cat='apple' limit 0,4";
		...
		?>
                   ...
                   <td  style=" width:255px; border:0px solid #0000CC;"align="center" >
                    ...
                    <div style="height:150px; width:230px; border:0px solid #000000;border-radius:15px; margin-top:10px;" align="center">
                    <a href="product.php?code=<?php echo $row['product_code'];?>" style="text-decoration:none;">
                    <img src="images/<?php echo $row['image1'];?>" height="130" width="185">
                    </a>
                    </div> 
                    ...
                    <tr><td style="color:#990000; height:30px; width:210px;" align="center" colspan="3">
                    <font style="color:#269FB2"><b><?php echo $row['product_code'];?></b></font></td></tr>                   
...
?>
 ...
 <!--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%-->
            ...
            <!--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%   MUSIC   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%-->        
			 ...
			 $query="select * from product where pro_cat='htc' limit 0,4";
...

				{
                 ...
                 ?>
                   ...
                   <td  style=" width:255px; border:0px solid #0000CC;"align="center" >
                    ...
                    <a href="product.php?code=<?php echo $row['product_code'];?>" style="text-decoration:none;">
                    <img src="images/<?php echo $row['image1'];?>" height="170" width="180"></a></div> 
            ...
            <!--%%%%%%%%%%%%%%%%%%%%%%%%%%%           CAMERAS              %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%-->        
			 ...
			 $query="select * from product where pro_cat='sony' limit 0,4";
		...
		?>
                 ...
                 <td  style=" width:255px; border:0px solid #0000CC;"align="center" >
                    ...
                    <div style="height:170px; width:230px; float:left;border:0px solid #000000;border-radius:15px;" align="center"><a href="product.php?code=<?php echo $row['product_code'];?>" style="text-decoration:none;">
                    <img src="images/<?php echo $row['image1'];?>"     height="170" width="180"></a></div> 
...
<!--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%-->
            ...
            <!--%%%%%%%%%%%%%%%%%%%%%%%%%% % MOBILES  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%-->        
			 ...
			 $query="select * from product where pro_cat='microsoft' limit 0,4";
