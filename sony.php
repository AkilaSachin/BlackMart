...
<title>BlackMart Shopping/sony</title>
...
<!--slider down data-->
           ...
           <tr><td>
                        ...
                        <div style="height:30px; width:1050px; border:0px solid #000000; color:#269FB2; font-size:18px; background-color:#DAD8D8;border-radius:5px; "><p style="margin-left:20px; margin-top:5px;"><b> Sony Products</b></p></div>      
            ...
            <!--%%%%%%%%%%%%%%%%%%%%%%%%%% % MOBILES  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%-->        
			 ...
			 $query="select * from product where pro_cat='sony'";
