...
<title>BlackMart/cartdetails</title>
...
<!--slider down data-->            
	...
	<a style="float:right; text-decoration:none;" href="history.php">View Purchase History</a>
...
$_SESSION['amt']=$amt;
      ...
      <td width="300" style="background-color:#FFFFFF;"></td>
       ...
       <td  width="200" align="center"><?php echo" <font color='#FF0000'> <b>Rs. </b></font>" .$amt;?></td>
            ...
            <a href="cardN.php"><img src="images/bt_prced.png"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
