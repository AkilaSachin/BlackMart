...
<title>BlackMart Shopping/newuser</title>
...
<!--slider down data-->            
         ...
         <font style=" font-size:18px;"><b>Account Information</b></font>
          ...
          <tr style="background-color:#CDEFF3; color:#828282;height:30px;"><td colspan="2"><b>Password</b></td></tr>
            ...
            <input type="submit" name="continue" value="Continue" style="border:1px solid #999999; border-radius:5px; height:35px; width:80px; font-size:16px; margin-right:25px;" align="middle"></td></tr>
